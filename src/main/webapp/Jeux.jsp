<%@ page import="com.example.miniprojet2.Arraylist" %>
...
<div class="container-md">
    ...
    <table class="tab">
       <%!
            public static boolean exist(char C,String ch){
    ...
    <br><br>
    <%if(test==true){%>
    <p><h1 class="msg">Bravo,Vous avez gangé</h1></p>

    <%} else if (test!=true && m!=null && m.getListMot().size()==7) {%>
    <p><h1 class="msg">Desolé,Vous avez perdu</h1></p>
    <%
        }
    %>
</div>
